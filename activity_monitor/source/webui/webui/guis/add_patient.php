	...
	<div id="bottomwrapper"> 
        ...
        <div id="columnwrapper">
			...
			?>
				...
				<br />
   				<form name="add patient" action="patient_script.php" method="post">
   				...
   				DOB: <input type="text" name="DOB" value="19000101"/><br />
   				<br />
   				Medical Conditions: <textarea name="MedicalConditions" rows="5" cols="50"></textarea>
   				<br /><br />
