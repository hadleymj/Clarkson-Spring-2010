================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : WWM_Activator Project Overview
===============================================================================

The application wizard has created this WWM_Activator application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your WWM_Activator application.

WWM_Activator.vcproj
...
WWM_Activator.h
    ...
    project specific headers and declares the CWWM_ActivatorApp application class.

WWM_Activator.cpp
    This is the main application source file that contains the application
    class CWWM_ActivatorApp.
...
res\WWM_Activatorsp.rc2
    This file contains resources that are not edited by Microsoft 
    Visual C++. You should place all resources not editable by
    the resource editor in this file.

res\WWM_Activator.ico
...
WWM_ActivatorDlg.h, WWM_ActivatorDlg.cpp - the dialog
    These files contain your CWWM_ActivatorDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named WWM_Activator.pch and a precompiled types file named StdAfx.obj.
