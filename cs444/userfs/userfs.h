...
typedef struct file_struct{
  ...
  /* allows for multi-level directories */
 /* BOOLEAN is_dir;
  int no_files;
...
/* Note, this struct is ONLY for the root directory */
typedef struct dir_struct{
  ...
  struct dir_struct * parent_dir;
  struct dir_struct * u_dir[MAX_SUB_DIRECTORIES];
}dir_struct;
